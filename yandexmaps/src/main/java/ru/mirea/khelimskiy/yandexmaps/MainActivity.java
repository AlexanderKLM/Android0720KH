package ru.mirea.khelimskiy.yandexmaps;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    private final String MAPKIT_API_KEY = "881e1df0-45e9-49f1-9a63-17016d7b15a2";
    ...
    @Override
        ...
        int BackPermissionStatus = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_BACKGROUND_LOCATION);
        if (BackPermissionStatus == PackageManager.PERMISSION_GRANTED && FinePermissionStatus == PackageManager.PERMISSION_GRANTED) {
            isWork = true;
        } else {
